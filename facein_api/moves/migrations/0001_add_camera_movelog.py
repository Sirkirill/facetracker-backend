    ...
    operations = [
            ...
            fields=[
                ...
                ('from_room',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT,
                                   related_name='from_cameras', related_query_name='from_camera',
                                   to='companies.Room',
                                   verbose_name='Камера на выходе в помещение')),
                ('to_room',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT,
                                   related_name='to_cameras', related_query_name='to_camera',
                                   to='companies.Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camera', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                                             related_name='logs', related_query_name='log',
                                             to='moves.Camera',
